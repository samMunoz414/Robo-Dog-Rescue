...
class Level():
    ...
    def powerups(lvl):
        ...
        if lvl == 0:
            for i in range(3):
                powerups_list.add(Gear(((i+24)*60)+15, 75))
            powerups_list.add(LaserGunBlock(1090, 430))
            powerups_list.add(LightningRodBlock(430, 255))

        if lvl == 1:
            # First screen
            for i in range(4):
                powerups_list.add(Gear(((i+3)*60)+15, 435))
                powerups_list.add(Gear(((i+3)*60)+15, 615))
                powerups_list.add(Gear(((i+9)*60)+15, 615))
            for i in range(2):
                powerups_list.add(Gear(((i+6)*60)+15, 255))
                powerups_list.add(Gear(((i+9)*60)+15, 255))
                powerups_list.add(Gear(((i+9)*60)+15, 75))
            powerups_list.add(LightningRodBlock(490, 255))

            # Second screen
            for i in range(2):
                powerups_list.add(Gear(((i+18)*60)+15, 435))
                powerups_list.add(Gear(((i+25)*60)+15, 435))
            for i in range(4):
                powerups_list.add(Gear(((i+23)*60)+15, 615))
            for i in range(3):
                powerups_list.add(Gear(((i+21)*60)+15, 75))
                powerups_list.add(Gear(((i+23)*60)+15, 255))
            # Third screen
            for i in range(2):
                powerups_list.add(Gear(((i+17)*120)+15, 435))
                powerups_list.add(Gear(((i+36)*60)+15, 75))
                powerups_list.add(Gear(((i+39)*60)+15, 75))
            for i in range(3):
                powerups_list.add(Gear(((i+34)*60)+15, 615))
                powerups_list.add(Gear(((i+41)*60)+15, 615))
                powerups_list.add(Gear(((i+42)*60)+15, 255))
            powerups_list.add(LaserGunBlock(2290, 70))
            # Fourth screen
            for i in range(3):
                powerups_list.add(Gear(((i+49)*60)+15, 615))
                powerups_list.add(Gear(((i+53)*60)+15, 615))
                powerups_list.add(Gear(((i+56)*60)+15, 255))
            for i in range(2):
                powerups_list.add(Gear(((i+52)*60)+15, 75))
                powerups_list.add(Gear(((i+49)*60)+15, 255))
        if lvl == 2:
            # First screen
            for i in range(3):
                powerups_list.add(Gear(((i+2)*60)+40, 615))
                powerups_list.add(Gear(((i+11)*60)+15, 435))
            for i in range(2):
                powerups_list.add(Gear(((i+6)*60)+40, 615))
                powerups_list.add(Gear(((i+4)*60)+15, 435))
                powerups_list.add(Gear(((i+6)*60)+15, 255))
                powerups_list.add(Gear(((i+4)*60)+15, 75))
                powerups_list.add(Gear(((i+10)*60)+15, 255))
            powerups_list.add(LightningRodBlock(190,70))
            # Second screen
            for i in range(2):
                powerups_list.add(Gear(((i+17)*60)+15, 255))
                powerups_list.add(Gear(((i+9)*180)+15, 255))
            for i in range(3):
                powerups_list.add(Gear(((i+22)*60)+15, 75))
            for i in range(5):
                powerups_list.add(Gear(((i+22)*60)+15, 435))
                powerups_list.add(Gear(((i+23)*60)+15, 615))
            # Third screen
            for i in range(2):
                powerups_list.add(Gear(((i+34)*60)+15, 75))
                powerups_list.add(Gear(((i+37)*60)+15, 75))
                powerups_list.add(Gear(((i+18)*120)+15, 435))
            for i in range(3):
                powerups_list.add(Gear(((i+42)*60)+15, 435))
                powerups_list.add(Gear(((i+38)*60)+15, 255))
            powerups_list.add(LaserGunBlock(2170, 70))
            # Fourth screen
            for i in range(3):
                powerups_list.add(Gear(((i+50)*60)+15, 75))
                powerups_list.add(Gear(((i+59)*60)+15, 255))
                powerups_list.add(Gear(((i+59)*60)+15, 615))
            for i in range(2):
                powerups_list.add(Gear(((i+27)*120)+15, 435))
            for i in range(4):
                powerups_list.add(Gear(((i+52)*60)+15, 615))

        if lvl == 3:
            # First screen
            for i in range(4):
                powerups_list.add(Gear(((i+8)*60)+15, 255))
                powerups_list.add(Gear(((i+11)*60)+15, 615))
            for i in range(2):
                powerups_list.add(Gear(((i+2)*60)+15, 435))
                powerups_list.add(Gear(((i+9)*120)+15, 435))
            powerups_list.add(LightningRodBlock(250, 430))
            # Second screen
            for i in range(5):
                powerups_list.add(Gear(((i+21)*60)+15, 255))
            for i in range(3):
                powerups_list.add(Gear(((i+28)*60)+15, 75))
            for i in range(6):
                powerups_list.add(Gear(((i+19)*60)+15, 615))
            for i in range(2):
                powerups_list.add(Gear(((i+30)*60)+15, 615))
            # Third screen
            for i in range(4):
                powerups_list.add(Gear(((i+35)*60)+15, 615))
            for i in range(2):
                powerups_list.add(Gear(((i+34)*60)+15, 435))
            for i in range(3):
                powerups_list.add(Gear(((i+42)*60)+15, 435))
                powerups_list.add(Gear(((i+38)*60)+15, 255))
            ...
            for i in range(2):
                powerups_list.add(Gear(((i+49)*60)+15, 615))
                powerups_list.add(Gear(((i+60)*60)+15, 435))
            for i in range(3):
                powerups_list.add(Gear(((i+50)*60)+15, 435))
                powerups_list.add(Gear(((i+56)*60)+15, 255))
            for i in range(4):
                powerups_list.add(Gear(((i+55)*60)+15, 615))
            # Fifth screen
            for i in range(2):
                powerups_list.add(Gear(((i+33)*120)+15, 255))
                powerups_list.add(Gear(((i+68)*60)+15, 435))
                powerups_list.add(Gear(((i+70)*60)+15, 75))
            for i in range(3):
                powerups_list.add(Gear(((i+72)*60)+15, 255))
            for i in range(4):
                powerups_list.add(Gear(((i+67)*60)+15, 615))
                powerups_list.add(Gear(((i+73)*60)+15, 615))
            # Sixth screen
            for i in range(3):
                powerups_list.add(Gear(((i+85)*60)+15, 255))
            for i in range(2):
                powerups_list.add(Gear(((i+89)*60)+15, 75))
    ...
    def floor(lvl):
        ...
        if lvl == 0:
            for i in range(32): # 2 screens of floor blocks
                floor_list.add(Platform("assets/TutorialFloor.png", i*60, 660))

        if lvl == 1 or lvl == 2:
            # Used for levels 1 and 2
            for i in range(64): # 4 screens of floor blocks
                floor_list.add(Platform("assets/new_floor.png", i*60, 660))
    ...
    def platform(lvl):
        ...
        if lvl == 0:
            # Ceiling blocks
            for i in range(32):
                platform_list.add(Platform("assets/tutorial_block2.png", i*60, -60))
            platform_list.add(Spike(240, 640))
            # First screen
            for i in range(3):
                platform_list.add(Platform("assets/tutorial_block2.png", (i+3)*60, 480))
            for i in range(3):
                platform_list.add(Platform("assets/tutorial_block2.png", (i+6)*60, 300))
            for i in range(3):
                platform_list.add(Platform("assets/tutorial_block2.png", ((i+8)*60)+30, 480))
            # Second screen
            for i in range(5):
                platform_list.add(Platform("assets/tutorial_block2.png", (i+21)*60, 300))
            for i in range(3):
                platform_list.add(Platform("assets/tutorial_block2.png", (i+17)*60, 480))
            for i in range(3):
                platform_list.add(Platform("assets/tutorial_block2.png", (i+24)*60, 120))
            # Block off beginning of game
            for i in range(12):
                platform_list.add(Platform("assets/tutorial_block2.png", -60, i*60))
            
        if lvl == 1 or lvl == 2:
            # Ceiling blocks
            for i in range(64):
                platform_list.add(Platform("assets/BlockGrey.png", i*60, -60))
            # Block off beginning of game
            for i in range(12):
                platform_list.add(Platform("assets/BlockGrey.png", -60, i*60))
        ...
        if lvl == 1:
            ...
            # First screen
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+3)*60, 480))
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+6)*60, 300))
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+9)*60, 120))
            # Second screen
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+18)*60, 480))
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+21)*60, 120))
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+23)*60, 300))
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+25)*60, 480))
            # Third screen
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+34)*60, 480))
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+36)*60, 120))
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+42)*60, 300))
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+40)*60, 480))
            # Fourth screen
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+49)*60, 300))
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+52)*60, 120))
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+56)*60, 300))
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+59)*60, 480))
            # platform_list.add(Platform("assets/BlockGrey.png", 100, 580))
        ...
        if lvl == 2:
            ...
            # First screen
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+4)*60, 480))
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+11)*60, 480))
            for i in range(2):
                platform_list.add(Platform("assets/BlockGrey.png", (i+6)*60, 300))
                platform_list.add(Platform("assets/BlockGrey.png", (i+10)*60, 300))
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+3)*60, 120))
            # Second screen
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+17)*60, 300))
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+22)*60, 480))
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+20)*60, 120))
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+27)*60, 300))
            # Third screen
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+34)*60, 120))
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+36)*60, 480))
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+38)*60, 300))
            for i in range(9):
                platform_list.add(Platform("assets/BlockGrey.png", (i+42)*60, 480))
            # Fourth screen
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+50)*60, 120))
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+54)*60, 480))
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+57)*60, 300))
        ...
        if lvl == 3:
            ...
            # First screen
            for i in range(9):
                platform_list.add(Platform("assets/BlockGrey.png", (i+2)*60, 480))
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+8)*60, 300))
            # Second screen
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+18)*60, 480))
            for i in range(7):
                platform_list.add(Platform("assets/BlockGrey.png", (i+20)*60, 300))
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+26)*60, 120))
            # Third screen
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+34)*60, 480))
            for i in range(5):
            ...
            # Fourth screen
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+50)*60, 480))
            for i in range(5):
                platform_list.add(Platform("assets/BlockGrey.png", (i+54)*60, 300))
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+59)*60, 480))
            # Fifth screen
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+66)*60, 300))
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+68)*60, 480))
            for i in range(2):
                platform_list.add(Platform("assets/BlockGrey.png", (i+70)*60, 120))
            for i in range(3):
                platform_list.add(Platform("assets/BlockGrey.png", (i+73)*60, 480))
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+72)*60, 300))
            for i in range(8):
                platform_list.add(Platform("assets/BlockGrey.png", (i+78)*60, 480))
            # Sixth screen
            for i in range(7):
                platform_list.add(Platform("assets/BlockGrey.png", (i+85)*60, 300))
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+88)*60, 120))
            for i in range(2):
                platform_list.add(Platform("assets/BlockGrey.png", (i+94)*60, 120))
            for i in range(4):
                platform_list.add(Platform("assets/BlockGrey.png", (i+92)*60, 480))
